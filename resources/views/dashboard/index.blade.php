    ...
    <div class="header">
        <div class="left">
            ...
            <div class="heading">
                ...
                <span class="org-name">{{$organizationProfile->name ?? ''}} @if($organizationProfile) <a href="{{url('event-list' , \Crypt::encrypt($organizationProfile->user_id) )}}" class="link-btn">Link<i class="fa-solid fa-arrow-up-right-from-square mx-2"></i></a> @endif</span>
            </div>
        </div>
        <div class="right">
