...
<div class="campaign-created">
    <div class="success">
        ...
        <div class="success-text">Your campaign has successfully updated</div>
    </div>
...
<script>
    function replaceMarkUp() {
        let iframeContent = '<iframe width="560" height="315" src="{{url('donate-now' , $campaignId)}}" title="Donation Widget box" frameborder="0" allow="accelerometer; auto; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>';
