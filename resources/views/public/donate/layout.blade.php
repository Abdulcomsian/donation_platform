...
<body>
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                            <li>
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" viewBox="0 0 21 21" fill="none">
                                                    <path d="M14.4856 15.6405C14.2596 15.6405 14.0429 15.7302 13.8831 15.8901C13.7233 16.0499 13.6335 16.2666 13.6335 16.4926C13.6335 16.7186 13.7233 16.9353 13.8831 17.0951C14.0429 17.2549 14.2596 17.3447 14.4856 17.3447L16.1899 17.3447C16.4159 17.3447 16.6326 17.2549 16.7924 17.0951C16.9522 16.9353 17.042 16.7186 17.042 16.4926L17.042 4.56281C17.042 4.33681 16.9522 4.12007 16.7924 3.96026C16.6326 3.80046 16.4159 3.71068 16.1899 3.71068L14.4856 3.71068C14.2596 3.71068 14.0429 3.80046 13.8831 3.96026C13.7233 4.12007 13.6335 4.33681 13.6335 4.56281C13.6335 4.7888 13.7233 5.00555 13.8831 5.16535C14.0429 5.32516 14.2596 5.41493 14.4856 5.41493L15.3377 5.41493L15.3377 15.6405L14.4856 15.6405ZM2.7092 11.0219L5.1122 14.4304C5.24252 14.6142 5.44027 14.7388 5.66223 14.7771C5.88418 14.8154 6.11228 14.7643 6.29666 14.635C6.38882 14.5704 6.46727 14.4882 6.52749 14.3931C6.58772 14.2981 6.62851 14.192 6.64753 14.0811C6.66654 13.9702 6.6634 13.8566 6.63828 13.7469C6.61316 13.6372 6.56656 13.5336 6.50117 13.442L5.03551 11.3798L11.9292 11.3798C12.1552 11.3798 12.372 11.2901 12.5318 11.1302C12.6916 10.9704 12.7814 10.7537 12.7814 10.5277C12.7814 10.3017 12.6916 10.085 12.5318 9.92516C12.372 9.76535 12.1552 9.67557 11.9292 9.67557L5.1122 9.67557L6.64603 7.63047C6.71317 7.54095 6.76202 7.43907 6.7898 7.33067C6.81757 7.22227 6.82372 7.10946 6.80789 6.99868C6.79207 6.8879 6.75458 6.78133 6.69756 6.68504C6.64055 6.58875 6.56513 6.50463 6.47561 6.43749C6.32811 6.32686 6.1487 6.26706 5.96433 6.26706C5.83204 6.26706 5.70157 6.29786 5.58325 6.35702C5.46492 6.41619 5.362 6.50208 5.28263 6.60791L2.72624 10.0164C2.61711 10.1605 2.55664 10.3356 2.55358 10.5164C2.55051 10.6972 2.60501 10.8742 2.7092 11.0219Z" fill="black"></path>
                                                </svg>
                                                <span class="sign-out">
                                                    Sign Out
                                                </span>
    ...
    <script>
        document.querySelector(".caret-drop").addEventListener("click" , function(e){
            dropdownMenu = document.querySelector(".dropdown-menu");
            dropdownMenu.classList.contains("block") ? dropdownMenu.classList.remove("block") : dropdownMenu.classList.add("block"); 
        })
    </script>
    @yield('script')
</body>
