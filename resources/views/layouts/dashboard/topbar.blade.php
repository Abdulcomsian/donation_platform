            ...
            <div class="icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    <path fill-rule="evenodd" clip-rule="evenodd"
                        d="M10.9958 2.78338C8.77555 2.78338 6.64627 3.66535 5.07634 5.23528C3.50642 6.80521 2.62444 8.93449 2.62444 11.1547C2.62444 13.3749 3.50642 15.5042 5.07634 17.0741C6.64627 18.644 8.77555 19.526 10.9958 19.526C13.2059 19.526 15.3258 18.6521 16.8937 17.0955C16.9022 17.0864 16.911 17.0774 16.9199 17.0685C16.928 17.0604 16.9361 17.0525 16.9444 17.0447C18.496 15.4777 19.3671 13.3611 19.3671 11.1547C19.3671 8.93448 18.4851 6.80521 16.9152 5.23528C15.3453 3.66535 13.216 2.78338 10.9958 2.78338ZM19.2447 17.8175C20.7613 15.94 21.5994 13.5906 21.5994 11.1547C21.5994 8.34243 20.4823 5.64534 18.4937 3.65677C16.5051 1.6682 13.808 0.551025 10.9958 0.551025C8.18349 0.551025 5.48641 1.6682 3.49783 3.65677C1.50926 5.64534 0.39209 8.34243 0.39209 11.1547C0.39209 13.967 1.50926 16.6641 3.49783 18.6526C5.48641 20.6412 8.18349 21.7584 10.9958 21.7584C13.4353 21.7584 15.7881 20.9177 17.667 19.3969L21.9257 23.6631C22.3612 24.0994 23.0679 24.1 23.5042 23.6645C23.9404 23.229 23.9411 22.5223 23.5056 22.086L19.2447 17.8175Z"
                        fill="#949494" />
                </svg>
            </div>
    ...
    <div class="profile">
        <div class="dropdown">
            <button class="btn btn-secondary" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown"
                aria-expanded="false">
                <img src="{{ asset('assets/images/burger-menu-right-svgrepo-com.png') }}" alt="">
            </button>
                        ...
                        <div class="profile-info">
                            ...
                            <div class="caret-drop">
                                <svg xmlns="http://www.w3.org/2000/svg" width="23" height="24" viewBox="0 0 23 24"
                                    fill="none">
                                    <path
                                        d="M15.5733 9.10425L11.4699 13.2076L7.36653 9.10425L6.01498 10.4558L11.4699 15.9107L16.9249 10.4558L15.5733 9.10425Z"
                                        fill="#949494" />
                                </svg>
                            </div>
                        </div>
...
<script>
    function toggleSidebarOpen(event) {
