...
Route::get('success-membership' , [MembershipController::class , 'succesfullySubscribeMembership']);
Route::get('cron-donation' , [DonationController::class ,'testCronDonation']);
Route::get('cron-membership' , [MembershipController::class ,'testCronMembership']);
